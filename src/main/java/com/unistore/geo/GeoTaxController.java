 ...
 */
@RestController
@RequestMapping(UniStoreServicesConstants.GEO_TAX_VERIFICATION_PATH)
public class GeoTaxController {
	  ...
	  private static final RestTemplate restTemplate = new RestTemplate();
	    ...
	    private final String callGeoCodeURL(String accessToken) {
		      log.info(" accessToken returned from  Auth Service is "+ accessToken);
		      String getCodeURL = servicesHelper.getGeoTax()+"?address=65 Rio Robles East, Unit 2000, San Jose, CA, 95134";
